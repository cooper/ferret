# === Document Model ===
#  File './test/10-irc-simple/Bot2.frt'
#      Package 'main'
#          Class 'Bot2'
#              Class method 'initializer__' { $address:Str $nick:Str $user:Str ?$port:Num ?$real:Str }
#                  Function body
#                      Instruction
#                          Need
...
my $file_name = './test/10-irc-simple/Bot2.frt';
my $pos = before_content( 'Bot2.frt', $file_name );
